...
def get_output_path(file_path: str, CURRENT_DATE: str, id, file_type) -> str:
...
def download_file(LINE_BOT_API: LineBotApi, USER_LOG_PATH: str, event, type: str, file_type: str, CURRENT_DATE: str) -> None:
